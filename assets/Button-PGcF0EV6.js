import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-Bn1Ys6_W.js";import{n,r}from"./iframe-t2jbFTRF.js";import{n as i,r as a,t as o}from"./emotion-css.esm-BqXpwIft.js";var s,c,l,u=e((()=>{a(),n(),s=t(),c=({children:e,icon:t,disabled:n=!1,color:a,variant:o=`primary`,size:c=`small`,textColor:u,radius:d,onClick:f,className:p,style:m,...h})=>{let g=r(),_=!!t&&!e,v=h[`aria-label`]??(_?`Действие`:void 0);return(0,s.jsxs)(`button`,{...h,"aria-label":v,disabled:n,onClick:f,style:m,className:i(l.base(g,n,u),l.variant(g,o,a),l.size(g,c,_),l.radius(c,d),p),children:[t&&(0,s.jsx)(`span`,{className:l.icon,children:t}),e]})},l={base:(e,t,n)=>o`
    display: inline-flex;
    align-items: center;
