import{n as e}from"./chunk-BneVvdWh.js";import{t}from"./jsx-runtime-Bn1Ys6_W.js";import{n,r}from"./iframe-t2jbFTRF.js";import{n as i,r as a,t as o}from"./emotion-css.esm-BqXpwIft.js";var s,c,l,u,d=e((()=>{a(),n(),s=t(),c=({children:e,variant:t=`text`,underline:n=t===`text`?`always`:`none`,size:a=`medium`,color:o=`mainNavy`,textColor:c,radius:d,leftIcon:f,rightIcon:p,external:m=!1,disabled:h=!1,className:g,style:_,target:v,rel:y,href:b,onClick:x,...S})=>{let C=r(),w=m?`_blank`:v,T=m?Array.from(new Set([...y?.split(` `)??[],`noreferrer`,`noopener`])).join(` `):y;return(0,s.jsxs)(`a`,{...S,href:h?void 0:b,target:w,rel:T,"aria-disabled":h||void 0,tabIndex:h?-1:S.tabIndex,onClick:e=>{if(h){e.preventDefault();return}x?.(e)},style:_,className:i(l({variant:t,underline:n,size:a,background:C[o],textColor:c?C[c]:t===`button`?`#ffffff`:C[o],radius:d,disabled:h}),g),children:[f&&(0,s.jsx)(`span`,{"aria-hidden":`true`,className:u,children:f}),(0,s.jsx)(`span`,{children:e}),p&&(0,s.jsx)(`span`,{"aria-hidden":`true`,className:u,children:p})]})},l=({variant:e,underline:t,size:n,background:r,textColor:i,radius:a,disabled:s})=>o`
  display: inline-flex;
  align-items: center;
  ...
  ${e===`button`?o`
      ...
      `:o`
        ...
        text-decoration-line: ${t===`always`?`underline`:`none`};
        text-underline-offset: 0.2em;
      `}

  &:hover {
    opacity: ${s?.55:.9};
    text-decoration-line: ${t===`hover`||t===`always`?`underline`:`none`};
  }

  &:active {
    transform: ${s||e!==`button`?`none`:`scale(0.98)`};
  }
`,u=o`
  display: inline-flex;
  align-items: center;
